...
describe('<PaymentForm />', () => {
  ...
  it('should call createPayment when it renders and render free if gets free games', async () => {
  ...
  it('should call createPayment when it renders and render error if has any error', async () => {
